...
class Publisher(Thread):
    def __init__(self, amqp_url, exchange, queue, routing_key):
        ...
        self.publisherConnection = RMQPublisher(
            amqp_url = amqp_url,
            exchange = exchange,
            queue = queue,
    ...
    def stop(self):
        self.publisherConnection.stop()



def main():

    #TODO: http://stackoverflow.com/questions/5273686/run-pika-ioloop-in-background-or-use-custom-ioloop
    ...
    time.sleep(0.5)
    publisherConnection.publisherConnection.publish_message('Hai!  I\'m not from this object.')
